...
/* harmony import */ var _restaurants_restaurants_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./restaurants/restaurants.component */ "./src/app/+pages/restaurants/restaurants.component.ts");
...
var routes = [
    { path: '', component: _restaurants_restaurants_component__WEBPACK_IMPORTED_MODULE_2__["RestaurantsComponent"] }
];
...
/* harmony import */ var _restaurants_restaurants_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./restaurants/restaurants.module */ "./src/app/+pages/restaurants/restaurants.module.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    PagesModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _restaurants_restaurants_module__WEBPACK_IMPORTED_MODULE_3__["RestaurantsModule"]
            ],
        })
    ], PagesModule);
    return PagesModule;
...
/***/ "./src/app/+pages/restaurants/restaurants-filter/restaurants-filter.component.html":
/*!*****************************************************************************************!*\
  !*** ./src/app/+pages/restaurants/restaurants-filter/restaurants-filter.component.html ***!
  \*****************************************************************************************/
...
module.exports = "<div class=\"row\">\n  <div class=\"col\">\n    <div class=\"input-group mb-3\">\n      <div class=\"input-group-prepend\">\n        <svg class=\"input-group-text\" id=\"filter-search\" viewBox=\"0 0 32 32\" width=\"64\" height=\"64\" fill=\"none\" stroke=\"white\" stroke-linecap=\"round\"\n          stroke-linejoin=\"round\" stroke-width=\"2\">\n          <circle cx=\"14\" cy=\"14\" r=\"12\" />\n          <path d=\"M23 23 L30 30\" />\n        </svg>\n      </div>\n      <input type=\"text\" class=\"form-control\" #query (keyup)=\"onQuery(query.value)\" placeholder=\"pesquise lugares, tipos, comidas, etc...\"\n        aria-label=\"filter-search\">\n    </div>\n  </div>\n</div>"

/***/ }),

/***/ "./src/app/+pages/restaurants/restaurants-filter/restaurants-filter.component.scss":
/*!*****************************************************************************************!*\
  !*** ./src/app/+pages/restaurants/restaurants-filter/restaurants-filter.component.scss ***!
  \*****************************************************************************************/
/*! no static exports found */
...
module.exports = ":host .input-group {\n  background-color: rgba(0, 0, 0, 0.1);\n  border-radius: 1rem; }\n\n:host .form-control,\n:host .input-group-text {\n  transition: all 0.2s ease-in-out;\n  border-color: rgba(255, 255, 255, 0.2);\n  background-color: transparent;\n  opacity: 0.5;\n  border-radius: 1rem; }\n\n:host .form-control::-webkit-input-placeholder,\n  :host .input-group-text::-webkit-input-placeholder {\n    color: white; }\n\n:host .form-control::-ms-input-placeholder,\n  :host .input-group-text::-ms-input-placeholder {\n    color: white; }\n\n:host .form-control::placeholder,\n  :host .input-group-text::placeholder {\n    color: white; }\n\n:host .form-control:placeholder,\n  :host .input-group-text:placeholder {\n    color: white; }\n\n:host .form-control:hover,\n  :host .input-group-text:hover {\n    opacity: 0.8; }\n\n:host .form-control {\n  padding-left: 38px;\n  color: white; }\n\n:host .input-group-text {\n  border: none;\n  position: absolute;\n  height: 38px;\n  width: 38px; }\n"

/***/ }),

/***/ "./src/app/+pages/restaurants/restaurants-filter/restaurants-filter.component.ts":
/*!***************************************************************************************!*\
  !*** ./src/app/+pages/restaurants/restaurants-filter/restaurants-filter.component.ts ***!
  \***************************************************************************************/
/*! exports provided: RestaurantsFilterComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RestaurantsFilterComponent", function() { return RestaurantsFilterComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _restaurants_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../restaurants.service */ "./src/app/+pages/restaurants/restaurants.service.ts");
...
var RestaurantsFilterComponent = /** @class */ (function () {
    function RestaurantsFilterComponent(api) {
        this.api = api;
        this.restaurants = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.querySubject = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
    }
    RestaurantsFilterComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.getRestaurants();
        this.querySubject
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["debounceTime"])(1000))
            .subscribe(function (query) { return _this.getRestaurants(query); });
    };
    RestaurantsFilterComponent.prototype.getRestaurants = function (query) {
        var _this = this;
        this.api.getRestaurants().subscribe(function (res) {
            if (!!query)
                res = res.filter(function (i) { return i.name.toLowerCase().indexOf(query) > -1 || i.cooking.toLowerCase().indexOf(query) > -1; });
            _this.restaurants.emit(res);
        });
    };
    RestaurantsFilterComponent.prototype.onQuery = function (query) {
        this.querySubject.next(query);
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], RestaurantsFilterComponent.prototype, "restaurants", void 0);
    RestaurantsFilterComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'restaurants-filter',
            template: __webpack_require__(/*! ./restaurants-filter.component.html */ "./src/app/+pages/restaurants/restaurants-filter/restaurants-filter.component.html"),
            styles: [__webpack_require__(/*! ./restaurants-filter.component.scss */ "./src/app/+pages/restaurants/restaurants-filter/restaurants-filter.component.scss")]
        }),
        __metadata("design:paramtypes", [_restaurants_service__WEBPACK_IMPORTED_MODULE_2__["RestaurantsService"]])
    ], RestaurantsFilterComponent);
    return RestaurantsFilterComponent;
}());
...
/***/ "./src/app/+pages/restaurants/restaurants-list/restaurants-list.component.html":
/*!*************************************************************************************!*\
  !*** ./src/app/+pages/restaurants/restaurants-list/restaurants-list.component.html ***!
  \*************************************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"pt-2 w-100 wrapper\">\r\n  <div *ngIf=\"!restaurants\" class=\"row flex-1\">\r\n    <div class=\"col relative\">\r\n      <loader></loader>\r\n    </div>\r\n  </div>\r\n\r\n  <div *ngIf=\"!!restaurants\" class=\"row flex-1\">\r\n    <a class=\"col-12 col-md-6 col-lg-6 col-xl-4 pb-4\" *ngFor=\"let restaurant of restaurants\" href=\"#\">\r\n      <div class=\"card mx-auto animated fadeIn\">\r\n        <div class=\"card-img-top relative\" [style.backgroundImage]=\"'url('+restaurant.coverImage+')'\">\r\n          <div class=\"card-img-top-emphasis\" [style.backgroundImage]=\"'url('+restaurant?.logoImage+')'\"></div>\r\n        </div>\r\n        <div class=\"card-body\">\r\n          <h3 class=\"card-title mb-0\">{{restaurant?.name}}</h3>\r\n          <div class=\"container-fluid\">\r\n            <div class=\"row\">\r\n              <div class=\"col-auto pl-0\">\r\n                <rating-stars [rating]=\"restaurant?.review\"></rating-stars>\r\n              </div>\r\n              <div class=\"col pr-0 d-flex justify-content-end align-items-center\">\r\n                <span class=\"badge badge-primary\">comida {{restaurant?.cooking.toLowerCase()}}</span>\r\n              </div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </a>\r\n  </div>\r\n</div>"

/***/ }),

/***/ "./src/app/+pages/restaurants/restaurants-list/restaurants-list.component.scss":
/*!*************************************************************************************!*\
  !*** ./src/app/+pages/restaurants/restaurants-list/restaurants-list.component.scss ***!
  \*************************************************************************************/
/*! no static exports found */
...
module.exports = ":host {\n  border-radius: 1rem; }\n  :host .wrapper {\n    overflow-y: auto;\n    overflow-x: hidden; }\n  :host .card {\n    transition: -webkit-transform 0.2s ease-in-out;\n    transition: transform 0.2s ease-in-out;\n    transition: transform 0.2s ease-in-out, -webkit-transform 0.2s ease-in-out;\n    overflow: hidden;\n    border: 0.5rem;\n    box-shadow: 0.2rem 0.2rem 0.5rem rgba(0, 0, 0, 0.2);\n    border-radius: 1rem; }\n  :host .card:hover .card-img-top-emphasis {\n      opacity: 1; }\n  :host .card-img-top,\n  :host .card-img-top-emphasis {\n    height: 240px;\n    background-size: cover;\n    background-position: center;\n    background-repeat: no-repeat; }\n  :host .card-img-top {\n    position: relative;\n    overflow: hidden; }\n  :host .card-img-top-emphasis {\n    background-color: white;\n    transition: all 0.2s ease-in-out;\n    opacity: 0;\n    position: absolute;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    top: 0; }\n"

/***/ }),

/***/ "./src/app/+pages/restaurants/restaurants-list/restaurants-list.component.ts":
/*!***********************************************************************************!*\
  !*** ./src/app/+pages/restaurants/restaurants-list/restaurants-list.component.ts ***!
  \***********************************************************************************/
...
var RestaurantsListComponent = /** @class */ (function () {
    ...
    RestaurantsListComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./restaurants-list.component.html */ "./src/app/+pages/restaurants/restaurants-list/restaurants-list.component.html"),
            styles: [__webpack_require__(/*! ./restaurants-list.component.scss */ "./src/app/+pages/restaurants/restaurants-list/restaurants-list.component.scss")]
        })
...
/***/ "./src/app/+pages/restaurants/restaurants.component.html":
/*!***************************************************************!*\
  !*** ./src/app/+pages/restaurants/restaurants.component.html ***!
  \***************************************************************/
/*! no static exports found */
...
module.exports = "<section class=\"container relative d-flex flex-column flex-1\">\n  <restaurants-filter (restaurants)=\"restaurants = $event\"></restaurants-filter>\n  <restaurants-list [restaurants]=\"restaurants\" class=\"d-flex flex-1\"></restaurants-list>\n</section>"

/***/ }),

/***/ "./src/app/+pages/restaurants/restaurants.component.scss":
/*!***************************************************************!*\
  !*** ./src/app/+pages/restaurants/restaurants.component.scss ***!
  \***************************************************************/
/*! no static exports found */
...
/***/ "./src/app/+pages/restaurants/restaurants.component.ts":
/*!*************************************************************!*\
  !*** ./src/app/+pages/restaurants/restaurants.component.ts ***!
  \*************************************************************/
...
var RestaurantsComponent = /** @class */ (function () {
    ...
    Object.defineProperty(RestaurantsComponent.prototype, "restaurants", {
        get: function () { return this._restaurants; },
        set: function (restaurants) {
            var _this = this;
            this._restaurants = [];
            var _loop_1 = function (restaurant) {
                var loaded = 0;
                // load logo
                if (!!restaurant.logoImage) {
                    ...
                    img.onload = function () {
                        ...
                        loaded++;
                        if (loaded === 2)
                            _this._restaurants.push(restaurant);
                    };
                }
                else
                    loaded++;
    ...
    RestaurantsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./restaurants.component.html */ "./src/app/+pages/restaurants/restaurants.component.html"),
            styles: [__webpack_require__(/*! ./restaurants.component.scss */ "./src/app/+pages/restaurants/restaurants.component.scss")],
        })
...
/* harmony import */ var _restaurants_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./restaurants.component */ "./src/app/+pages/restaurants/restaurants.component.ts");
/* harmony import */ var _restaurants_filter_restaurants_filter_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./restaurants-filter/restaurants-filter.component */ "./src/app/+pages/restaurants/restaurants-filter/restaurants-filter.component.ts");
/* harmony import */ var _restaurants_list_restaurants_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./restaurants-list/restaurants-list.component */ "./src/app/+pages/restaurants/restaurants-list/restaurants-list.component.ts");
/* harmony import */ var _restaurants_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./restaurants.service */ "./src/app/+pages/restaurants/restaurants.service.ts");
/* harmony import */ var _common_common_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../+common/common.module */ "./src/app/+common/common.module.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    RestaurantsModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _restaurants_filter_restaurants_filter_component__WEBPACK_IMPORTED_MODULE_4__["RestaurantsFilterComponent"],
                _restaurants_list_restaurants_list_component__WEBPACK_IMPORTED_MODULE_5__["RestaurantsListComponent"]
            ],
            exports: [_restaurants_component__WEBPACK_IMPORTED_MODULE_3__["RestaurantsComponent"]],
            providers: [_restaurants_service__WEBPACK_IMPORTED_MODULE_6__["RestaurantsService"]]
        })
    ], RestaurantsModule);
...
/***/ "./src/app/+pages/restaurants/restaurants.service.ts":
/*!***********************************************************!*\
  !*** ./src/app/+pages/restaurants/restaurants.service.ts ***!
  \***********************************************************/
...
var RestaurantsService = /** @class */ (function () {
    ...
    RestaurantsService.prototype.getRestaurants = function () {
        return this.http.get('assets/mock/restaurants.json');
    };
